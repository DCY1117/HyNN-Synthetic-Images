...
results_folder = "/results_Only_CNN_TINTO_1e-3_1e-4/"
...
modelX = Model(inputs=[cnn_model.input], outputs=x)
...
modelX.save(images_folder+'/predictions_Only_CNN_TINTO_1e-3_1e-4/modelX_8.h5')
