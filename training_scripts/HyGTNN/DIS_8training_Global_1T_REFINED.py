...
images_folder = "HyNNImages/Regression/images_8antennas_DIS_refined"
results_folder = "/results_Global_1T_REFINED_1e-3_1e-4/"
...
encoder = Encoder(
            ...
            attention_key_dim=40,
            attention_value_dim=40,
...
#Start branch 2
tower_2 = Conv2D(16, (5,5), activation='relu',padding="same")(x)
...
modelX.save(images_folder+'/predictions_Global_1T_REFINED_1e-3_1e-4/modelX_8.h5')
...
modelY.save(images_folder+'/predictions_Global_1T_REFINED_1e-3_1e-4/modelY_8.h5')
...
# VALIDATION RESULTS
folder = images_folder+"/predictions_Global_1T_REFINED_1e-3_1e-4/DIS/8antennas/validation/"
...
folder = images_folder+"/predictions_Global_1T_REFINED_1e-3_1e-4/DIS/8antennas/test/"
if not os.path.exists(folder):
    os.makedirs(folder)
