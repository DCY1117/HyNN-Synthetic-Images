...
results_folder = "/results_CNN_IGTD_1e-3_1e-4/"
...
modelX.save(images_folder+'/predictions_CNN_IGTD_1e-3_1e-4/modelX_8.h5')
...
modelY.save(images_folder+'/predictions_CNN_IGTD_1e-3_1e-4/modelY_8.h5')
...
# VALIDATION RESULTS
folder = images_folder+"/predictions_CNN_IGTD_1e-3_1e-4/DIS/8antennas/validation/"
...
folder = images_folder+"/predictions_CNN_IGTD_1e-3_1e-4/DIS/8antennas/test/"
if not os.path.exists(folder):
    os.makedirs(folder)
