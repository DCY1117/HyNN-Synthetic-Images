...
results_folder = "/results_ViT_Refined/"
...
# VALIDATION RESULTS
folder = images_folder+"/predictions_ViT_Refined/DIS/8antennas/validation/"
...
with open(results_filename, 'w') as results_file:
    ...
    results_file.write(f"Error medio de test: {error_valid}\n")
...
folder = images_folder+"/predictions_ViT_Refined/DIS/8antennas/test/"
if not os.path.exists(folder):
    os.makedirs(folder)
