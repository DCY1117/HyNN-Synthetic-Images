...
images_folder = "HyNNImages/Regression/images_8antennas_DIS_IGTD_40_40"
results_folder = "/results_1T_1N_IGTD_1e-3_1e-4/"
...
x1 = tf.stack(x_ffnn, axis=-1)

#Start branch 1
tower_1 = Conv2D(16, (3,3), activation='relu',padding="same")(x1)
...
modelX.save(images_folder+'/predictions_1T_1N_IGTD_1e-3_1e-4/modelX_8.h5')
...
modelY.save(images_folder+'/predictions_1T_1N_IGTD_1e-3_1e-4/modelY_8.h5')
...
# VALIDATION RESULTS
folder = images_folder+"/predictions_1T_1N_IGTD_1e-3_1e-4/DIS/8antennas/validation/"
...
folder = images_folder+"/predictions_1T_1N_IGTD_1e-3_1e-4/DIS/8antennas/test/"
if not os.path.exists(folder):
    os.makedirs(folder)
