...
#modelX.save(images_folder+'/predictions_ViT_TINTO/modelX_8.h5')
...
# VALIDATION RESULTS
folder = images_folder+"/predictions_VIT/DIS/8antennas/validation/"
...
folder = images_folder+"/predictions_VIT/DIS/8antennas/test/"
if not os.path.exists(folder):
    os.makedirs(folder)
